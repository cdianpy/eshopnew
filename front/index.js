...
$(document).on("pageshow","#home",function(){
	$.ajax({
		url: "http://127.0.0.1:8000/computer/product_list/?limit=9&ordering=-sold", 
...
$(document).on("pageshow","#productList",function(){
    ...
    $.ajax({
    	url: "http://127.0.0.1:8000/computer/product_list_by_category/?ordering=-sold&category="+category, 
    	success: function(res){
        	console.log(res);
            ...
            if (res.next != null){
                ...
                global_next = "http://127.0.0.1:8000/computer/product_list_by_category/?ordering=-sold&category="+category;                       
            }
            ...
            if (res.previous != null){
                ...
                global_prev = "http://127.0.0.1:8000/computer/product_list_by_category/?ordering=-sold&category="+category;                       
            }
    ...
    $(".manufacturer").click(function(){
        ...
        var tmp = "http://127.0.0.1:8000/computer/product_list_by_category_manufacturer/?ordering="+$(this).attr("ordering")+"&category="+category+"&manufacturer="+$(this).attr("value");

        $.ajax({
            url: "http://127.0.0.1:8000/computer/product_list_by_category_manufacturer/?ordering="+$(this).attr("ordering")+"&category="+category+"&manufacturer="+$(this).attr("value"), 
            success: function(res){
                console.log(res);
                $("#page_no").html("1");
...
$(".ordering").click(function(){
    ...
    var tmp = "http://127.0.0.1:8000/computer/product_list_by_category/?ordering="+$(this).attr("value")+"&category="+category;

    $.ajax({
        url: "http://127.0.0.1:8000/computer/product_list_by_category/?ordering="+$(this).attr("value")+"&category="+category, 
        success: function(res){
            console.log(res);
            $("#page_no").html("1");
...
$(document).on("pageshow","#productDetails",function(){
    ...
    $.ajax({
        url: "http://127.0.0.1:8000/computer/product_retrieve/" + id + "/", 
        success: function(res){
            console.log(res);
    ...
    $("#addtocart").click(function(){
        ...
        $.ajax({
            url: "http://127.0.0.1:8000/computer/order_create/", 
            type: "POST",
            data: data,
            headers: myheader(),        
            success: function(res){
...
$(document).on("pageshow","#usercenter",function(){
    var id = 0;
    $.ajax({
        url: "http://127.0.0.1:8000/computer/user_info/", 
        headers: myheader(),
        success: function(res){
            console.log(res);
            id = res.id;
    ...
    $("#update").click(function(){
        ...
        $.ajax({
            url: "http://127.0.0.1:8000/computer/user_profile_ru/" + id + "/", 
            type: "PATCH",
            data: data,
            headers: myheader(),        
            success: function(res){
...
$(document).on("pageshow","#useraddress",function(){
    $.ajax({
        url: "http://127.0.0.1:8000/computer/delivery_address_lc/", 
        headers: myheader(),
        success: function(res){
            console.log(res);
...
$(document).on("pageshow","#useraddress_details",function(){
    ...
    $.ajax({
        url: "http://127.0.0.1:8000/computer/delivery_address_rud/" + id + "/", 
        headers: myheader(),
        success: function(res){
            console.log(res);
...
$(document).on("pageshow","#usercart",function(){
    ...
    $.ajax({
        url: "http://127.0.0.1:8000/computer/cart_list/", 
        headers: myheader(),
        success: function(res){
            console.log(res);
            ...
            for (var i = 0; i < res.results.length; i++) {
                ...
                $(".gotoDetails").click(function(){
                    ...
                    $.ajax({
                        url: "http://127.0.0.1:8000/computer/order_rud/" + $(this).attr("value") + "/", 
                        type: "DELETE",                 
                        headers: myheader(),
                        success: function(res){
                            console.log(res);
...
$(document).on("pageshow","#userorder",function(){
    ...
    $.ajax({
        url: "http://127.0.0.1:8000/computer/order_list/", 
        headers: myheader(),
        success: function(res){
            console.log(res);
            ...
            for (i in cart) {
                ...
                $("#view").append(
                  '<tr>'+
                    '<td><img class="img-responsive" style="max-height:60px;" src="http://127.0.0.1:8000/media/' + cart[i].image + '"></td>'+
                    '<td>' + cart[i].model + '</td>'+
                    '<td>' + cart[i].price + '</td>'+
...
$(document).on("pageshow","#usersignin",function(){
    $("#submit").click(function(){
        ...
        $.ajax({
            url: "http://127.0.0.1:8000/computer/user_create/", 
            type: "POST",
            data: data,
